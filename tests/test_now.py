...
class TestNowScript:
    ...
    def test_main_function_prints_timestamp(self, capsys):
        """Test that the main function prints a timestamp to stdout."""
        now.main()
        
        captured = capsys.readouterr()
        output = captured.out.strip()
        
        # Verify output is not empty and matches ISO-8601 format
        assert output, "Main function should print output"
